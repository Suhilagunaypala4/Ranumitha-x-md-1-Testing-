...
async (conn, mek, m, { from, reply }) => {
    const githubRepoURL = 'https://github.com/Ranumithaofc/Ranumitha-x-md-1';
...
> ${config.DESCRIPTION}`;
        ...
        await conn.sendMessage(from, {
            image: { url: config.MENU_IMAGE_URL || 'https://files.catbox.moe/ebcvj0.jpg' },
            ...
            contextInfo: { 
                ...
                forwardedNewsletterMessageInfo: {
                    ...
                    newsletterName: config.OWNER_NAME || '𝚁𝙰𝙽𝚄𝙼𝙸𝚃𝙷𝙰',
                    serverMessageId: 143
                }
            }
        }, { quoted: mek });
        ...
        // Send audio
        await conn.sendMessage(from, {
            audio: { url: 'https://files.catbox.moe/iwomi6.mp3' },
            mimetype: 'audio/mp4',
            ptt: true,
            contextInfo: { 
                mentionedJid: [m.sender],
