...
const sessdata = config.SESSION_ID.replace("RANUMITHA~", '');
...
const port = process.env.PORT || 9090;
  ...
  let up = `*✨ Hello, 𝚁𝙰𝙽𝚄𝙼𝙸𝚃𝙷𝙰-𝚇-𝙼𝙳 Legend! ✨*

╭─〔 *🤖 𝚁𝙰𝙽𝚄𝙼𝙸𝚃𝙷𝙰-𝚇-𝙼𝙳 BOT* 〕  
├─▸ *Simplicity. Speed. Power. BY 𝚁𝙰𝙽𝚄𝙼𝙸𝚃𝙷𝙰 |*  
...
╭──〔 🔗 *Quick Links* 〕  
├─ 📢 *Join Our Channel:*  
│   Click [**Here**](https://whatsapp.com/channel/0029Vb6aJYE4Y9lidzolSR2t) to join!  
├─ ⭐ *Give Us a Star:*  
│   Star Us [**Here**](https://github.com/Ranumithaofc/Ranumitha-x-md-1)!  
╰─🛠️ *Prefix:* \`${prefix}\`

> _© MADE BY 𝚁𝙰𝙽𝚄𝙼𝙸𝚃𝙷𝙰_`;
    conn.sendMessage(conn.user.id, { image: { url: `https://files.catbox.moe/r6ukvt.jpg` }, caption: up })
  }
  })
 ...
 //================ownerreact==============
  ...
  if(senderNumber.includes("94762095304")){
  if(isReact) return
  m.react("🤍")
   }
  //==========public react============//
